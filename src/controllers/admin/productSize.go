...
func DetailProductSize(c *gin.Context) {
	...
	user, err := models.FindOneProductSize(&id)
...
func CreateProductSize(c *gin.Context) {
	...
	user, err := models.CreateProductSize(col, values)
...
func UpdateProductSize(c *gin.Context) {
	...
	user, err := models.UpdateProductSize(values, id)
...
func DeleteProductSize(c *gin.Context) {
	...
	user, err := models.DeleteProductSize(id)
