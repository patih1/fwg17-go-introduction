...
func DetailProductTags(c *gin.Context) {
	...
	user, err := models.FindOneProductTags(&id)
...
func CreateProductTags(c *gin.Context) {
	...
	user, err := models.CreateProductTags(col, values)
...
func UpdateProductTags(c *gin.Context) {
	...
	user, err := models.UpdateProductTags(values, id)
...
func DeleteProductTags(c *gin.Context) {
	...
	user, err := models.DeleteProductTags(id)
