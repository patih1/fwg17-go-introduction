...
func DetailProductRatings(c *gin.Context) {
	...
	user, err := models.FindOneProductRatings(&id)
...
func CreateProductRatings(c *gin.Context) {
	...
	user, err := models.CreateProductRatings(col, values)
...
func UpdateProductRatings(c *gin.Context) {
	...
	user, err := models.UpdateProductRatings(values, id)
...
func DeleteProductRatings(c *gin.Context) {
	...
	user, err := models.DeleteProductRatings(id)
