...
func DetailProductVariant(c *gin.Context) {
	...
	user, err := models.FindOneProductVariant(&id)
...
func CreateProductVariant(c *gin.Context) {
	...
	user, err := models.CreateProductVariant(col, values)
...
func UpdateProductVariant(c *gin.Context) {
	...
	user, err := models.UpdateProductVariant(values, id)
...
func DeleteProductVariant(c *gin.Context) {
	...
	user, err := models.DeleteProductVariant(id)
